...
\hypertitle[']{Informatique}{1}{FSAB}{1401}{2011}{Juin}{All}
...
\begin{center}
	\small{\url{https://github.com/Gp2mv3/Syntheses/tree/master/src/q1/info-FSAB1401/exam/2011/Juin/All/src}}
\end{center}
un code complet et fonctionnel de chacune des classes de l'examen.
]
...
% Question 5
\section{}
Écrivez complètement la méthode \code{addProcess} de la classe \code{Cluster}. Aidez-vouz de l'exemple présenté en page 2. Indice: vous pouvez utiliser la valeur de \code{count}.
