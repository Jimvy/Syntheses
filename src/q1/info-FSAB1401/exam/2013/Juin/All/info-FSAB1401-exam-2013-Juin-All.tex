...
\hypertitle[']{Informatique}{1}{FSAB}{1401}{2013}{Juin}{All}
{Sébastien Binard \and Jean-Martin Vlaeminck}
{Olivier Bonaventure et Charles Pecheur}[
\paragraph{Remarque de l'auteur}
Le répertoire Github contient également, à l'adresse
\begin{center}
	\small{\url{https://github.com/Gp2mv3/Syntheses/tree/master/src/q1/info-FSAB1401/exam/2013/Juin/All/src}}
\end{center}
des codes sources fonctionnels pour la majorité des classes de l'examen.
Il est néanmoins probable que des erreurs soient encore présentes;
...
\begin{solution}
	...
	\lstinputlisting[linerange={111-136}]{src/DigramStats.java}
\end{solution}
\newpage
...
\begin{solution}
	...
	\lstinputlisting[linerange={30-64}]{src/DigramStats.java}
\end{solution}
%\newpage
