...
%FIXME : c'est faux, surtout la partie p=mv. Il y a un facteur de Lorentz gamma
% qui "vaut" l'infini quand la particule se déplace à c et ça compense la masse
% nulle, pour que p soit non nul. La suite avec E=mc^2 n'a pas de sens
% (énergie nulle alors qu'on a défini plus haut qu'un photon a une énergie ?).
% En fait, E=pc. Je propose de retirer cette digression. JM
...
% NOT SURE
% En effet, ce n'est pas vraiment ça ; mais numéro de la période = valeur de n de la sous-couche ns ajoutée au début.
%\begin{center}
...
Exemple le fluor \ce{F} : \configElectronique{9} ou \configElectronique[courte]{9}.
%TODO ajouter exceptions
\paragraph{Exceptions}
Les atomes du groupe 11 (cuivre, argent, or) complètent leur sous-couche $\dorb$ avec un des électrons de la sous-couche $\sorb$, en désaccord avec la règle de Klechkowsky (où la couche $\sorb$ devrait être remplie), car cette configuration est plus stable énergiquement. Cela a d'ailleurs une conséquence sur leur conductivité électrique. Ainsi, au lieu d'être [Ar] 3d9 4s2, le cuivre a pour configuration électronique [Ar] 3d10 4s1. Test à supprimer : \configElectronique{29} et \configElectronique[courte]{29}. %FIXME

L'atome de chrome complète également sa demi-sous-couche $\dorb$ au dépit de la sous-couche $\sorb$. Et plus on descend dans le tableau, moins les atomes respectent les règles.
