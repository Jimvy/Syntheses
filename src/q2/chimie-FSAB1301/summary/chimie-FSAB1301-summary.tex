...
\newcommand\qrev{\ensuremath{q_{\mathrm{rev}}}}
\newcommand\kc{\ensuremath{K_{\mathrm{c}}}}
\newcommand\kp{\ensuremath{K_{\mathrm{p}}}}
%\newcommand\keq{\ensuremath{K_{\text{éq}}}}
...
on a juste
\[ \Delta H = \sum v_r{E_l}_\text{réactifs} - \sum v_p{E_l}_\text{produits} \]
...
c'est à dire,
par mole d'un composé ayant un coefficient st\oe{}chiométrique 1 dans la réaction.
...
des produits et des réactifs pondérées par leur coefficient st\oe{}chiométrique.
...
\begin{align*}
    ...
    &+ \int_{T_\mathrm{ref}}^{T_\text{fusion}}
    \frac{C^\text{cristal}_\mathrm{p, m}}{T}\dif T
    + \frac{\Delta H\std_\text{fusion}}{T_\text{fusion}}\\
    &+  \int_{T_\text{fusion}}^{T_\text{ébullition}}
    \frac{C^\text{liquide}_\mathrm{p, m}}{T}\dif T
    + \frac{\Delta H\std_\text{vaporisation}}{T_\text{ébullition}}\\
    &+  \int_{T_\text{ébullition}}^{T_2}
    \frac{C^\text{gaz}_\mathrm{p, m}}{T}\dif T
\end{align*}
où $\frac{\Delta H\std_\text{fusion}}{T_\text{fusion}}$ et
$\frac{\Delta H\std_\text{vaporisation}}{T_\text{ebullition}}$ représentent
...
toujours le cas lorsque les coefficients st\oe{}chiométriques des composés de
...
\begin{align*}
  \Delta S\std &= \sum v_p S\std_\text{produits}
  - \sum v_r S\std_\text{réactifs}\\
  \Delta H &= \sum v_p \Delta {H_f}_\text{produits}
  - \sum v_r \Delta {H_f}_\text{réactifs}
\end{align*}
