...
%  C'est erroné. En fait, p=mv n'est pas valable pour des grandes vitesses
%  ou pour des masses nulles ; dans ces cas, il faut utiliser la relativité
%  qui corrige les tendances vers infini et 0 de ces équation. En fait,
%  E=pc pour des particules de masse 0 (photon).
...
%TODO ce n'est pas dualité, mais comportement ondulatoire
...
Les atomes du groupe 11 (cuivre, argent, or) complètent leur sous-couche $\dorb$ avec un des électrons de la sous-couche $\sorb$ externe, en désaccord avec la règle de Klechkowsky (où la sous-couche $\sorb$ devrait être remplie), car cette configuration est plus stable énergiquement.%Pas sûr de l'orthographe
Cela a d'ailleurs une conséquence sur leur conductivité électrique.
...
\section{Électrons de valence et électrons de cœur}%FIXME a corriger si je me trompe ; je dois vérifier si en accord avec examens ; cf forum
...
Exemple : Pour le scandium, de configuration \configElectronique{21}, les électrons de coeur sont \configElectronique{18}, les électrons de valence $\text{4s}^2$ et l'électron de la sous-couche $3\dorb$ n'est ni l'un ni l'autre.

Les électrons des sous-couches $\dorb$ peuvent participer aux liaisons chimiques (paragraphe~\ref{subpar:valence_d}).
...
\begin{itemize}
  ...
  %TODO ajouter pê plus de détails ?
\end{itemize}
...
%TOdo verifier si vraiment couche de valence
