...
\begin{figure}
	...
	\draw[Green] (16, -0.5) node {$\omega$ (\si{\radian\per\second})};
	\draw[Blue] (16, -0.8) node {$\Omega$};
	\draw[Red] (16, -1.2) node {$k$};
	...
	\draw (14, 0.1) -- (14, -0.1) node[below] {14};
	\draw[Green]
	(-10, -0.5) node {$-\omega_e=-20\pi$}
	(-4, -0.5) node {$-M = -8\pi$}
	(1, -0.5) node {$2\pi$}
	(4, -0.5) node {$M = 8\pi$}
	(10, -0.5) node {$\omega_e=2\pi f_e=20\pi$};
	\draw[Blue]
	(-10, -0.8) node {$-\Omega_e = -2\pi$}
	(-4, -0.8) node {$-0.8\pi$}
	(1, -0.8) node {$\frac{2\pi}{T_e}$}
	(4, -0.8) node {$0.8\pi$}
	(10, -0.8) node {$\Omega_e = 2\pi$};
	\draw[Red]
	(-10, -1.2) node {$k=-N=-10$}
